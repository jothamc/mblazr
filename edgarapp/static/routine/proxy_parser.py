...
try:
    ...
    for filingtype, company, filingdate in myresult:
        ...
        if (filingtype == 'DEF 14A' and (str(company).upper() > 'BOSTON BEER CO INC') and (company != 'CENTRAL SECURITIES CORP' and company != 'CHEMED CORP' and company != 'DAVEY TREE EXPERT CO' and company != 'BIG LOTS INC')):
            mydb = mysql.connector.connect(host='172.104.7.112',
                                         database='edgarData',
                                         user='reguser',
                                         password='Edgar@2020')
